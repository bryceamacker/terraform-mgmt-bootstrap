...
az group create --resource-group $TF_VAR_hub_res_group --location $TF_VAR_region -o table
az storage account create --resource-group $TF_VAR_hub_res_group \
...
terraform import azurerm_resource_group.mgmt "/subscriptions/$SUB_ID/resourceGroups/$TF_VAR_hub_res_group"
terraform import azurerm_storage_account.state_storage "/subscriptions/$SUB_ID/resourceGroups/$TF_VAR_hub_res_group/providers/Microsoft.Storage/storageAccounts/$TF_VAR_state_storage"