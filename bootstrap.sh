...
# Now set Terraform variables
export TF_VAR_state_storage=$BACKEND_STORAGE_ACCOUNT
export TF_VAR_mgmt_res_group=$BACKEND_RESGRP
export TF_VAR_region=$REGION
export TF_VAR_azdo_pat="IGNORED"
...
terraform import azurerm_storage_account.state_storage "/subscriptions/$SUB_ID/resourceGroups/$BACKEND_RESGRP/providers/Microsoft.Storage/storageAccounts/$BACKEND_STORAGE_ACCOUNT"